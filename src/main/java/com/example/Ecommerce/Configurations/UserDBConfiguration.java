...
@Configuration
public class AuthenticationConfiguration implements CommandLineRunner {

    private final AuthenticationRepository authenticationRepository;
    private final PasswordEncoder passwordEncoder;

    @Autowired
    public AuthenticationConfiguration(AuthenticationRepository authenticationRepository, PasswordEncoder passwordEncoder) {
    ...
    public void run(String... args) throws Exception {
        ...
        if (authenticationRepository.findByUsername("mazen").isEmpty()) {
            ...
            AuthenticationDB defaultUser = new AuthenticationDB();
